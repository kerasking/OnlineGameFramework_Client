...
int lua_red_luabinding_ConnDelegate_bindDisconnect(lua_State* tolua_S)
{
    int argc = 0;
    ConnDelegate* cobj = nullptr;
    bool ok  = true;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S,1,"ConnDelegate",0,&tolua_err)) goto tolua_lerror;
#endif

    cobj = (ConnDelegate*)tolua_tousertype(tolua_S,1,0);

#if COCOS2D_DEBUG >= 1
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_red_luabinding_ConnDelegate_bindDisconnect'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_red_luabinding_ConnDelegate_bindDisconnect'", nullptr);
            return 0;
        }
        cobj->bindDisconnect(arg0);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ConnDelegate:bindDisconnect",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_red_luabinding_ConnDelegate_bindDisconnect'.",&tolua_err);
#endif

    return 0;
}
int lua_red_luabinding_ConnDelegate_bindConnect(lua_State* tolua_S)
{
    int argc = 0;
    ConnDelegate* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_red_luabinding_ConnDelegate_bindConnect'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_red_luabinding_ConnDelegate_bindConnect'", nullptr);
            return 0;
        }
        cobj->bindConnect(arg0);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ConnDelegate:bindConnect",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_red_luabinding_ConnDelegate_bindConnect'.",&tolua_err);
#endif

    return 0;
}
int lua_red_luabinding_ConnDelegate_bindError(lua_State* tolua_S)
{
    int argc = 0;
    ConnDelegate* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_red_luabinding_ConnDelegate_bindError'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_red_luabinding_ConnDelegate_bindError'", nullptr);
            return 0;
        }
        cobj->bindError(arg0);
        lua_settop(tolua_S, 1);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ConnDelegate:bindError",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_red_luabinding_ConnDelegate_bindError'.",&tolua_err);
#endif

    return 0;
}
int lua_red_luabinding_ConnDelegate_constructor(lua_State* tolua_S)
{
    int argc = 0;
    ConnDelegate* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_red_luabinding_ConnDelegate_constructor'", nullptr);
            return 0;
        }
        cobj = new ConnDelegate();
        tolua_pushusertype(tolua_S,(void*)cobj,"ConnDelegate");
        tolua_register_gc(tolua_S,lua_gettop(tolua_S));
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ConnDelegate:ConnDelegate",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_red_luabinding_ConnDelegate_constructor'.",&tolua_err);
#endif
...
int lua_register_red_luabinding_ConnDelegate(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"ConnDelegate");
        tolua_function(tolua_S,"new",lua_red_luabinding_ConnDelegate_constructor);
        tolua_function(tolua_S,"bindDisconnect",lua_red_luabinding_ConnDelegate_bindDisconnect);
        tolua_function(tolua_S,"bindConnect",lua_red_luabinding_ConnDelegate_bindConnect);
        tolua_function(tolua_S,"bindError",lua_red_luabinding_ConnDelegate_bindError);
    tolua_endmodule(tolua_S);
